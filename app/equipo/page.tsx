...
export default async function EquipoPage() {
  ...
  return <AppShell><PageContainer><PageHeader eyebrow="Administración" title="Equipo" description="Administra encargados y groomistas disponibles para la operación." /><EquipoBrowser managers={managers.data.datos.filter((manager) => manager.rol === "encargado")} groomers={groomers.data.datos} branches={branches.data.datos} assignments={assignments.data.datos} /></PageContainer></AppShell>;
}
